...
const VideoPage = () => {
  ...
  const metaTitle = `${videoDetail.snippet.title} - Your Site Name`;
  const metaDescription = videoDetail.snippet.description.substring(0, 160);
  const metaKeywords = arraySearch.join(', ');
  return (
    <>
      <Helmet>
